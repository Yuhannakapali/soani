...
{{-- main content --}}
        ...
        <div class="btn-holder">
            ...
            <a href="{{route('testimonial.create')}}"><button type="submit" class="btn btn-primary "><i class="fa fa-plus"></i> Create </button></a>
            </div>    
        </div>
                      ...
                      @if (!empty($datas))
                        ...
                        <tr>
                          ...
                          <td class="project-actions text-right">  
                            <a class="btn btn-info btn-sm" href="{{route('testimonial.edit',$data)}}">
