                  ...
                  <div class="col-sm-10">
                    <div class="iq-entry-image">
                      <img
                        ...
                        data-wow-duration="1.0s"
                        src="https://iqonicthemes.com/themes/vizion/chatbot/images/blog/blog-img7.jpg"
                        alt="image"
                      />
                    </div>
                    ...
                    <div class="iq-detail-box mt-4">
                      <p class=" wow fadeInUp" data-wow-duration="1.0s">
                        ...
                        laborum.Pri quas audiam virtute ut, case utamur
                        fuisset eam ut, iisque accommodare an eam. Reque
                        blandit qui eu, cu vix nonumy volumus. Legendos
                        intellegam id usu, vide oporteat vix eu, id illud
                      ...
                      <div class="row mb-5 mt-5">
                        <div class="col-md-4">
                          <img
                            class="img-fluid mt-3 mb-3 w-100"
                            src="https://iqonicthemes.com/themes/vizion/chatbot/images/blog/blog-img1.jpg"
                            alt="blog"
                          />
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="blog-commentbox">
                      <div
                        class="media info-block wow fadeInUp"
                        data-wow-duration="1.0s"
                      >
                        <img
                          class="mr-3"
                          src="https://iqonicthemes.com/themes/vizion/chatbot/images/blog/comment/01.jpg"
                          alt="image"
                        />
                        <div class="media-body">
                          <h5>Rinks Kevin</h5>
                          <div class="iq-comment-metadata white">
                            <a href="#"
                          ...
                          <p class="mt-1 mb-0">
                            CEO &amp; It was popularised in the 1960s with
                            the and more recently with desktop publishing
                      ...
                      <div id="comments">
                        <h3 class="wow fadeInUp" data-wow-duration="1.0s">
                          Comments <small>/ 21</small>
                        </h3>
                        <div class="iq-comment-list">
                          <div
                            class="media iq-comments-media wow fadeInUp"
                            data-wow-duration="1.0s"
                          >
                            <img
                              class="mr-3"
                              src="https://iqonicthemes.com/themes/vizion/chatbot/images/blog/comment/02.jpg"
                              alt="image"
                            />
                            <div class="media-body">
                              <h5>Kevin Martin</h5>
                          ...
                          >
                            <img
                              class="mr-3"
                              src="https://iqonicthemes.com/themes/vizion/chatbot/images/blog/comment/03.jpg"
                              alt="image"
                            />
                            <div class="media-body">
                              <h5>Rinks Kevin</h5>
                          ...
                          >
                            <img
                              class="mr-3"
                              src="https://iqonicthemes.com/themes/vizion/chatbot/images/blog/comment/04.jpg"
                              alt="image"
                            />
                            <div class="media-body">
                              <h5>Martin</h5>
                          ...
                          <div class="contact-form">
                            <div class="row">
                              <div class="col-lg-6 col-sm-12">
                                <div
                                  class="form-group section-field wow fadeInUp"
                                  data-wow-duration="1.0s"
                                >
                                  <label>Name</label>
                                  <input
                              ...
                              <div class="col-lg-12 col-sm-12">
                                ...
                                <button
                                  ...
                                  type="submit"
                                  value="Send"
                                  class="button form-button pull-right wow fadeInUp"
                                  data-wow-duration="1.0s"
                                >
                                  Send Post
                                </button>
