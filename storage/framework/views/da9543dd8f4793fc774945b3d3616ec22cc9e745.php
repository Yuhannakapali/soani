<section>
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-12 mt-5">
          ...
          <div class="p-3">
            <a class="button grey mt-2" href="/ARVR" role="button"> Learn More</a>
          </div>
        </div>
        <div class="col-lg-6 col-md-12 mt-5">
          <img
            class="img-fluid top-img1 w-100"
            src="images/services/vr.png"
            alt="image"
          />
        </div>
      </div>
  ...
  </section><?php /**PATH C:\Users\Kuro_neko\Documents\repo\soani\resources\views/frontend/section/service.blade.php ENDPATH**/ ?>